...
QT_MOC_LITERAL(1, 4, 24), // "communicationEstablished"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 4), // "Car*"
QT_MOC_LITERAL(4, 35, 8) // "otherCar"

    },
    "Car\0communicationEstablished\0\0Car*\0"
    "otherCar"
};
...
void Car::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->communicationEstablished((*reinterpret_cast< Car*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Car::*)(Car * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Car::communicationEstablished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Car::communicationEstablished(Car * _t1)
{
